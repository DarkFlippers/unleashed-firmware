...
void nfc_scene_emv_transactions_on_enter(void* context) {
    nfc_protocol_support_extra_on_enter(EmvExtraSceneTransactions, context);
}

bool nfc_scene_emv_transactions_on_event(void* context, SceneManagerEvent event) {
    return nfc_protocol_support_extra_on_event(EmvExtraSceneTransactions, context, event);
}

void nfc_scene_emv_transactions_on_exit(void* context) {
    nfc_protocol_support_extra_on_exit(EmvExtraSceneTransactions, context);
}
