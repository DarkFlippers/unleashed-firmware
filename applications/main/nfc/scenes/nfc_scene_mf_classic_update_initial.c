...
void nfc_scene_mf_classic_update_initial_on_enter(void* context) {
    nfc_protocol_support_extra_on_enter(MfClassicExtraSceneUpdateInitial, context);
}

bool nfc_scene_mf_classic_update_initial_on_event(void* context, SceneManagerEvent event) {
    return nfc_protocol_support_extra_on_event(MfClassicExtraSceneUpdateInitial, context, event);
}

void nfc_scene_mf_classic_update_initial_on_exit(void* context) {
    nfc_protocol_support_extra_on_exit(MfClassicExtraSceneUpdateInitial, context);
}
