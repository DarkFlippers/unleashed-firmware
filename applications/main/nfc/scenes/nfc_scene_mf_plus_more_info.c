...
void nfc_scene_mf_plus_more_info_on_enter(void* context) {
    nfc_protocol_support_extra_on_enter(MfPlusExtraSceneMoreInfo, context);
}

bool nfc_scene_mf_plus_more_info_on_event(void* context, SceneManagerEvent event) {
    return nfc_protocol_support_extra_on_event(MfPlusExtraSceneMoreInfo, context, event);
}

void nfc_scene_mf_plus_more_info_on_exit(void* context) {
    nfc_protocol_support_extra_on_exit(MfPlusExtraSceneMoreInfo, context);
}
