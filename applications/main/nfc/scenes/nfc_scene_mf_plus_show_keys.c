...
void nfc_scene_mf_plus_show_keys_on_enter(void* context) {
    nfc_protocol_support_extra_on_enter(MfPlusExtraSceneShowKeys, context);
}

bool nfc_scene_mf_plus_show_keys_on_event(void* context, SceneManagerEvent event) {
    return nfc_protocol_support_extra_on_event(MfPlusExtraSceneShowKeys, context, event);
}

void nfc_scene_mf_plus_show_keys_on_exit(void* context) {
    nfc_protocol_support_extra_on_exit(MfPlusExtraSceneShowKeys, context);
}
