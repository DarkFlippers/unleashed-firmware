...
void nfc_scene_mf_plus_update_initial_on_enter(void* context) {
    nfc_protocol_support_extra_on_enter(MfPlusExtraSceneUpdateInitial, context);
}

bool nfc_scene_mf_plus_update_initial_on_event(void* context, SceneManagerEvent event) {
    return nfc_protocol_support_extra_on_event(MfPlusExtraSceneUpdateInitial, context, event);
}

void nfc_scene_mf_plus_update_initial_on_exit(void* context) {
    nfc_protocol_support_extra_on_exit(MfPlusExtraSceneUpdateInitial, context);
}
