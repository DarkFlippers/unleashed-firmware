...
void nfc_scene_mf_plus_dict_attack_on_enter(void* context) {
    nfc_protocol_support_extra_on_enter(MfPlusExtraSceneDictAttack, context);
}

bool nfc_scene_mf_plus_dict_attack_on_event(void* context, SceneManagerEvent event) {
    return nfc_protocol_support_extra_on_event(MfPlusExtraSceneDictAttack, context, event);
}

void nfc_scene_mf_plus_dict_attack_on_exit(void* context) {
    nfc_protocol_support_extra_on_exit(MfPlusExtraSceneDictAttack, context);
}
