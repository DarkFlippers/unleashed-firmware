...
ADD_SCENE(nfc, mf_ultralight_aes_keys, MfUltralightAesKeys)
ADD_SCENE(nfc, mf_ultralight_aes_keys_list, MfUltralightAesKeysList)
ADD_SCENE(nfc, mf_ultralight_aes_keys_delete, MfUltralightAesKeysDelete)
ADD_SCENE(nfc, mf_ultralight_aes_keys_add, MfUltralightAesKeysAdd)
ADD_SCENE(nfc, mf_ultralight_aes_keys_warn_duplicate, MfUltralightAesKeysWarnDuplicate)
...
ADD_SCENE(nfc, mf_plus_update_initial_success, MfPlusUpdateInitialSuccess)
ADD_SCENE(nfc, mf_plus_update_initial_wrong_card, MfPlusUpdateInitialWrongCard)
ADD_SCENE(nfc, mf_plus_keys, MfPlusKeys)
ADD_SCENE(nfc, mf_plus_keys_list, MfPlusKeysList)
ADD_SCENE(nfc, mf_plus_keys_delete, MfPlusKeysDelete)
ADD_SCENE(nfc, mf_plus_keys_add, MfPlusKeysAdd)
ADD_SCENE(nfc, mf_plus_keys_warn_duplicate, MfPlusKeysWarnDuplicate)
