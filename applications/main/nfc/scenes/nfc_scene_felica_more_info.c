...
void nfc_scene_felica_more_info_on_enter(void* context) {
    nfc_protocol_support_extra_on_enter(FelicaExtraSceneMoreInfo, context);
}

bool nfc_scene_felica_more_info_on_event(void* context, SceneManagerEvent event) {
    return nfc_protocol_support_extra_on_event(FelicaExtraSceneMoreInfo, context, event);
}

void nfc_scene_felica_more_info_on_exit(void* context) {
    nfc_protocol_support_extra_on_exit(FelicaExtraSceneMoreInfo, context);
}
