...
void nfc_scene_mf_classic_mfkey_nonces_info_on_enter(void* context) {
    nfc_protocol_support_extra_on_enter(MfClassicExtraSceneMfkeyNoncesInfo, context);
}

bool nfc_scene_mf_classic_mfkey_nonces_info_on_event(void* context, SceneManagerEvent event) {
    return nfc_protocol_support_extra_on_event(MfClassicExtraSceneMfkeyNoncesInfo, context, event);
}

void nfc_scene_mf_classic_mfkey_nonces_info_on_exit(void* context) {
    nfc_protocol_support_extra_on_exit(MfClassicExtraSceneMfkeyNoncesInfo, context);
}
