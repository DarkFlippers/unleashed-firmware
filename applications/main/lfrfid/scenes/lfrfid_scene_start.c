...
void lfrfid_scene_start_on_enter(void* context) {
    ...
    submenu_add_item(
        submenu, "Leer", LfRfidMenuIndexRead, lfrfid_scene_start_submenu_callback, app);
    submenu_add_item(
        submenu, "Guardados", LfRfidMenuIndexSaved, lfrfid_scene_start_submenu_callback, app);
    submenu_add_item(
        submenu,
        "Agregar Manualmente",
