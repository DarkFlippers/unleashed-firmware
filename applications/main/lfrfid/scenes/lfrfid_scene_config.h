...
ADD_SCENE(lfrfid, save_method, SaveMethod)
ADD_SCENE(lfrfid, save_fields, SaveFields)
...
ADD_SCENE(lfrfid, settings, Settings)
ADD_SCENE(lfrfid, settings_write_targets, SettingsWriteTargets)
