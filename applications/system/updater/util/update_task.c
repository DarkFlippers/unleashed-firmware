...
static const char* update_task_stage_descr[] = {
    ...
    [UpdateTaskStageReadManifest] = "Cargando act. manifiesto",
    [UpdateTaskStageValidateDFUImage] = "Comprobando DFU",
    [UpdateTaskStageFlashWrite] = "Escribiendo flash",
    [UpdateTaskStageFlashValidate] = "Validando flash",
    [UpdateTaskStageRadioImageValidate] = "Comprob. radio FW",
    [UpdateTaskStageRadioErase] = "Desins. radio FW",
    [UpdateTaskStageRadioWrite] = "Escribiendo Radio FW",
    [UpdateTaskStageRadioInstall] = "Inst. radio FW",
    [UpdateTaskStageRadioBusy] = "Nucleo 2 ocupado",
