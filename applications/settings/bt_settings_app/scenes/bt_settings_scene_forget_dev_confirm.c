...
void bt_settings_scene_forget_dev_confirm_on_enter(void* context) {
    ...
    dialog_ex_set_header(dialog, "¿Olvidar todos los disp.?", 64, 0, AlignCenter, AlignTop);
    dialog_ex_set_text(
        dialog, "Todos los disp.\nSe desemparejaran", 64, 14, AlignCenter, AlignTop);
    dialog_ex_set_left_button_text(dialog, "Cancel");
    dialog_ex_set_right_button_text(dialog, "Aceptar");
