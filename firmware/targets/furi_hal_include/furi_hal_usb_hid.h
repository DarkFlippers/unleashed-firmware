...
/** HID keyboard key codes BE */
enum HidKeyboardKeysBE {
    HID_KEYBOARD_BE_ERROR_ROLLOVER = 0x01,
    HID_KEYBOARD_BE_POST_FAIL = 0x02,
    HID_KEYBOARD_BE_ERROR_UNDEFINED = 0x03,

    HID_KEYBOARD_BE_ENTER = 0x28,
    HID_KEYBOARD_BE_ESC = 0x29,
    HID_KEYBOARD_BE_BACKSPACE = 0x2A,
    HID_KEYBOARD_BE_TAB = 0x2B,
    HID_KEYBOARD_BE_SPACE = 0x2C,

    HID_KEYBOARD_BE_A = 0x14,
    HID_KEYBOARD_BE_B = 0x05,
    HID_KEYBOARD_BE_C = 0x06,
    HID_KEYBOARD_BE_D = 0x07,
    HID_KEYBOARD_BE_E = 0x08,
    HID_KEYBOARD_BE_F = 0x09,
    HID_KEYBOARD_BE_G = 0x0A,
    HID_KEYBOARD_BE_H = 0x0B,
    HID_KEYBOARD_BE_I = 0x0C,
    HID_KEYBOARD_BE_J = 0x0D,
    HID_KEYBOARD_BE_K = 0x0E,
    HID_KEYBOARD_BE_L = 0x0F,
    HID_KEYBOARD_BE_M = 0x33,
    HID_KEYBOARD_BE_N = 0x11,
    HID_KEYBOARD_BE_O = 0x12,
    HID_KEYBOARD_BE_P = 0x13,
    HID_KEYBOARD_BE_Q = 0x04,
    HID_KEYBOARD_BE_R = 0x15,
    HID_KEYBOARD_BE_S = 0x16,
    HID_KEYBOARD_BE_T = 0x17,
    HID_KEYBOARD_BE_U = 0x18,
    HID_KEYBOARD_BE_V = 0x19,
    HID_KEYBOARD_BE_W = 0x1D,
    HID_KEYBOARD_BE_X = 0x1B,
    HID_KEYBOARD_BE_Y = 0x1C,
    HID_KEYBOARD_BE_Z = 0x1A,

    HID_KEYBOARD_BE_SQUARE = 0x35,
    HID_KEYBOARD_BE_AND = 0x1E,
    HID_KEYBOARD_BE_E_ACCENT = 0x1F,
    HID_KEYBOARD_BE_DOUBLE_QUOTE = 0x20,
    HID_KEYBOARD_BE_SINGLE_QUOTE = 0x21,
    HID_KEYBOARD_BE_LEFT_PARENTHESIS = 0x22,
    HID_KEYBOARD_BE_DOUBLE_DOLLAR = 0x23,
    ...
    HID_KEYBOARD_BE_DOLLAR = 0x30,
    HID_KEYBOARD_BE_U_BACKTICK = 0x34,
    HID_KEYBOARD_BE_SMALLER = 0x64,
    HID_KEYBOARD_BE_COMMA = 0x10,
    HID_KEYBOARD_BE_SEMI_COLON = 0x36,
    HID_KEYBOARD_BE_DOUBLE_POINTS = 0x37,
    HID_KEYBOARD_BE_EQUAL = 0x38,
    HID_KEYBOARD_BE_MICRO = 0x31,
    
    HID_KEYBOARD_BE_CAPS_LOCK = 0xC1,
    HID_KEYBOARD_BE_F1 = 0xC2,
    HID_KEYBOARD_BE_F2 = 0xC3,
    HID_KEYBOARD_BE_F3 = 0xC4,
    HID_KEYBOARD_BE_F4 = 0xC5,
    HID_KEYBOARD_BE_F5 = 0xC6,
    HID_KEYBOARD_BE_F6 = 0xC7,
    HID_KEYBOARD_BE_F7 = 0xC8,
    HID_KEYBOARD_BE_F8 = 0xC9,
    HID_KEYBOARD_BE_F9 = 0xCA,
    HID_KEYBOARD_BE_F10 = 0xCB,
    HID_KEYBOARD_BE_F11 = 0xCC,
    HID_KEYBOARD_BE_F12 = 0xCD,
    HID_KEYBOARD_BE_PRINT = 0x63,
    HID_KEYBOARD_BE_SCROLL_LOCK = 0x47,
    HID_KEYBOARD_BE_PAUSE = 0x48,
    HID_KEYBOARD_BE_INSERT = 0xD1,
    HID_KEYBOARD_BE_HOME = 0xD2,
    HID_KEYBOARD_BE_PAGE_UP = 0xD3,
    HID_KEYBOARD_BE_DELETE = 0xD4,
    HID_KEYBOARD_BE_END = 0xD5,
    HID_KEYBOARD_BE_PAGE_DOWN = 0xD6,
    HID_KEYBOARD_BE_RIGHT_ARROW = 0xD7,
    HID_KEYBOARD_BE_LEFT_ARROW = 0xD8,
    HID_KEYBOARD_BE_DOWN_ARROW = 0xD9,
    HID_KEYBOARD_BE_UP_ARROW = 0xDA,
    HID_KEYBOARD_BE_NUM_LOCK = 0x53,
    HID_KEYBOARD_BE_NON_US = 0x64,
    HID_KEYBOARD_BE_APPLICATION = 0x65,
};

/** ASCII to keycode conversion table BE */
static const uint16_t hid_asciimap_be[] = {
    HID_KEYBOARD_NONE, // NUL
    HID_KEYBOARD_NONE, // SOH
    HID_KEYBOARD_NONE, // STX
    HID_KEYBOARD_NONE, // ETX
    ...
    HID_KEYBOARD_NONE, // ACK
    HID_KEYBOARD_NONE, // BEL
    HID_KEYBOARD_BE_BACKSPACE, // BS   Backspace
    HID_KEYBOARD_BE_TAB, // TAB  Tab
    HID_KEYBOARD_BE_ENTER, // LF   Enter
    HID_KEYBOARD_NONE, // VT
    HID_KEYBOARD_NONE, // FF
    HID_KEYBOARD_NONE, // CR
    HID_KEYBOARD_NONE, // SO
    ...
    HID_KEYBOARD_NONE, // RS
    HID_KEYBOARD_NONE, // US
    HID_KEYBOARD_BE_SPACE, // ' ' Space
    HID_KEYBOARD_BE_EXCLAMATION, // !
    HID_KEYBOARD_BE_DOUBLE_QUOTE, // "
    HID_KEYBOARD_BE_DOUBLE_QUOTE | KEY_MOD_RIGHT_ALT, // #
    HID_KEYBOARD_BE_DOLLAR, // $
    HID_KEYBOARD_BE_U_BACKTICK | KEY_MOD_LEFT_SHIFT, // %
    HID_KEYBOARD_BE_AND, // &
    HID_KEYBOARD_BE_SINGLE_QUOTE, // '
    HID_KEYBOARD_BE_LEFT_PARENTHESIS, // (
    HID_KEYBOARD_BE_RIGHT_PARENTHESIS, // )
    HID_KEYBOARD_BE_DOLLAR | KEY_MOD_LEFT_SHIFT, // *
    HID_KEYBOARD_BE_EQUAL | KEY_MOD_LEFT_SHIFT, // +
    HID_KEYBOARD_BE_COMMA, // ,
    HID_KEYBOARD_BE_DASH, // -
    HID_KEYBOARD_BE_SEMI_COLON | KEY_MOD_LEFT_SHIFT, // .
    HID_KEYBOARD_BE_DOUBLE_POINTS | KEY_MOD_LEFT_SHIFT, // /
    HID_KEYBOARD_BE_A_BACKTICK | KEY_MOD_LEFT_SHIFT, // 0
    HID_KEYBOARD_BE_AND | KEY_MOD_LEFT_SHIFT, // 1
    HID_KEYBOARD_BE_E_ACCENT | KEY_MOD_LEFT_SHIFT, // 2
    HID_KEYBOARD_BE_DOUBLE_QUOTE | KEY_MOD_LEFT_SHIFT, // 3
    HID_KEYBOARD_BE_SINGLE_QUOTE | KEY_MOD_LEFT_SHIFT, // 4
    HID_KEYBOARD_BE_LEFT_PARENTHESIS | KEY_MOD_LEFT_SHIFT, // 5
    HID_KEYBOARD_BE_DOUBLE_DOLLAR | KEY_MOD_LEFT_SHIFT, // 6
    HID_KEYBOARD_BE_E_BACKTICK | KEY_MOD_LEFT_SHIFT, // 7
    HID_KEYBOARD_BE_EXCLAMATION | KEY_MOD_LEFT_SHIFT, // 8
    HID_KEYBOARD_BE_C_CEDILLE | KEY_MOD_LEFT_SHIFT, // 9
    HID_KEYBOARD_BE_DOUBLE_POINTS, // :
    HID_KEYBOARD_BE_SEMI_COLON, // ;
    HID_KEYBOARD_BE_SMALLER, // <
    HID_KEYBOARD_BE_EQUAL, // =
    HID_KEYBOARD_BE_SMALLER | KEY_MOD_LEFT_SHIFT, // >
    HID_KEYBOARD_BE_COMMA | KEY_MOD_LEFT_SHIFT, // ?
    HID_KEYBOARD_BE_E_ACCENT | KEY_MOD_RIGHT_ALT, // @
    HID_KEYBOARD_BE_A | KEY_MOD_LEFT_SHIFT, // A
    HID_KEYBOARD_BE_B | KEY_MOD_LEFT_SHIFT, // B
    HID_KEYBOARD_BE_C | KEY_MOD_LEFT_SHIFT, // C
    HID_KEYBOARD_BE_D | KEY_MOD_LEFT_SHIFT, // D
    HID_KEYBOARD_BE_E | KEY_MOD_LEFT_SHIFT, // E
    HID_KEYBOARD_BE_F | KEY_MOD_LEFT_SHIFT, // F
    HID_KEYBOARD_BE_G | KEY_MOD_LEFT_SHIFT, // G
    HID_KEYBOARD_BE_H | KEY_MOD_LEFT_SHIFT, // H
    HID_KEYBOARD_BE_I | KEY_MOD_LEFT_SHIFT, // I
    HID_KEYBOARD_BE_J | KEY_MOD_LEFT_SHIFT, // J
    HID_KEYBOARD_BE_K | KEY_MOD_LEFT_SHIFT, // K
    HID_KEYBOARD_BE_L | KEY_MOD_LEFT_SHIFT, // L
    HID_KEYBOARD_BE_M | KEY_MOD_LEFT_SHIFT, // M
    HID_KEYBOARD_BE_N | KEY_MOD_LEFT_SHIFT, // N
    HID_KEYBOARD_BE_O | KEY_MOD_LEFT_SHIFT, // O
    HID_KEYBOARD_BE_P | KEY_MOD_LEFT_SHIFT, // P
    HID_KEYBOARD_BE_Q | KEY_MOD_LEFT_SHIFT, // Q
    HID_KEYBOARD_BE_R | KEY_MOD_LEFT_SHIFT, // R
    HID_KEYBOARD_BE_S | KEY_MOD_LEFT_SHIFT, // S
    HID_KEYBOARD_BE_T | KEY_MOD_LEFT_SHIFT, // T
    HID_KEYBOARD_BE_U | KEY_MOD_LEFT_SHIFT, // U
    HID_KEYBOARD_BE_V | KEY_MOD_LEFT_SHIFT, // V
    HID_KEYBOARD_BE_W | KEY_MOD_LEFT_SHIFT, // W
    HID_KEYBOARD_BE_X | KEY_MOD_LEFT_SHIFT, // X
    HID_KEYBOARD_BE_Y | KEY_MOD_LEFT_SHIFT, // Y
    HID_KEYBOARD_BE_Z | KEY_MOD_LEFT_SHIFT, // Z
    HID_KEYBOARD_BE_CIRCUMFLEX | KEY_MOD_RIGHT_ALT, // [
    HID_KEYBOARD_BE_SMALLER | KEY_MOD_RIGHT_ALT, // bslash
    HID_KEYBOARD_BE_DOLLAR | KEY_MOD_RIGHT_ALT, // ]
    HID_KEYBOARD_BE_CIRCUMFLEX, // ^
    HID_KEYBOARD_BE_DASH | KEY_MOD_LEFT_SHIFT, // _
    HID_KEYBOARD_BE_MICRO | KEY_MOD_RIGHT_ALT, // `
    HID_KEYBOARD_BE_A, // a
    HID_KEYBOARD_BE_B, // b
    HID_KEYBOARD_BE_C, // c
    HID_KEYBOARD_BE_D, // d
    ...
    HID_KEYBOARD_BE_Y, // y
    HID_KEYBOARD_BE_Z, // z
    HID_KEYBOARD_BE_SINGLE_QUOTE | KEY_MOD_RIGHT_ALT, // {
    HID_KEYBOARD_BE_AND | KEY_MOD_RIGHT_ALT, // |
    HID_KEYBOARD_BE_A_BACKTICK | KEY_MOD_RIGHT_ALT, // }
    HID_KEYBOARD_BE_EQUAL | KEY_MOD_RIGHT_ALT, // ~
    HID_KEYBOARD_NONE, // DEL
};
