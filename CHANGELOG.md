...
- Desktop: **Main menu styles** - Settings -> Desktop -> Menu Style picks between Default, PS4, Wii, DSi, C64, Compact, and more, each shipped as its own plugin - bunch of the layouts ported from [Momentum Firmware](https://github.com/Next-Flip/Momentum-Firmware) (by @apfxtech | PR #1119)
