...
## Other changes
- Desktop: Settings -> Desktop no longer shows the menu it was opened from while it starts - the menu style plugins are now scanned behind a loading screen, and once per run instead of on every return to the settings list (by @mishamyte | PR #1123 | Fixes #1122)
