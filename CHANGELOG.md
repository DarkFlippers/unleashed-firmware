...
- NFC: WashCity, Microel, MiZIP, Bip, CharlieCard, Saflok and CSC no longer present values from blocks that were never read; MiZIP no longer guesses which of its two blocks holds the current credit, and CharlieCard no longer picks a balance sector by comparing two unread counters (by @mishamyte | PR #1103 | Fixes #1098)
