...
- NFC: SmartRider and Bambu again parse dumps saved before the file format recorded which blocks were read, such as converted PM3 dumps (by @mishamyte | PR #1103 | Fixes #1098)
